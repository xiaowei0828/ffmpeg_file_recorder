...
#define WB_TRACE_ERROR(...) 
//__android_log_print(ANDROID_LOG_ERROR, "lqp_test", __VA_ARGS__)

#define WB_TRACE_DEBUG WB_TRACE_ERROR

#define LQP_TRACE(a, b, c, ...)
//__android_log_print(ANDROID_LOG_ERROR, "lqp_test", __VA_ARGS__)
#else
#define WB_TRACE_ERROR(...)    Trace::Add(webrtc::kTraceError, webrtc::kTraceVoice, -1, __VA_ARGS__)
#define WB_TRACE_DEBUG(...)    Trace::Add(webrtc::kTraceDebug, webrtc::kTraceVoice, -1, __VA_ARGS__)

#define LQP_TRACE       WEBRTC_TRACE
#endif
