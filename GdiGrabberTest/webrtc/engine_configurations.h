...
#define WEBRTC_CODEC_ISACFX 1 //#define WEBRTC_CODEC_ISACFX  1 //Fix-point iSAC implementation.
#else
#define WEBRTC_CODEC_ISACFX  1// Floating-point iSAC implementation (default).
...
#endif
#define WEBRTC_WENBA // add by zyx
// ----------------------------------------------------------------------------
